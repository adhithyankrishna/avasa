...
export default function Homepage() {
  ...
  useEffect(() => {
    ...
    mm.add({
      ...
      // ----------------------------------------------------
      // 6. Safety Coda Panels
      // ----------------------------------------------------
      document.querySelectorAll(".safety-panel").forEach(section => {
  ...
  return (
    <div ref={containerRef}>
        ...
        <div className="showcase-pin-stage">
          ...
          <div className="cards-row">
            <div className="pillar-card card-living" onClick={() => router.push("/living-classrooms")} onTouchStart={() => {}}>
              ...
              <div className="card-content">
                ...
                <p className="card-desc">Experiential outdoor camps, team bonding, and leadership walks.</p>
              </div>
            </div>
            ...
            <div className="pillar-card card-adventure" onClick={() => router.push("/adventure")} onTouchStart={() => {}}>
              ...
              <div className="card-content">
                ...
                <p className="card-desc">Ziplining over canopies, kayaking, and custom treks.</p>
              </div>
            </div>
            ...
            <div className="pillar-card card-habitat" onClick={() => router.push("/habitat")} onTouchStart={() => {}}>
              ...
              <div className="card-content">
                ...
                <p className="card-desc">Treetop stays, geodesic luxury domes, Tipis, and tree tents.</p>
              </div>
            </div>
            ...
            <div className="pillar-card card-projects" onClick={() => router.push("/projects")} onTouchStart={() => {}}>
              ...
              <div className="card-content">
                ...
                <p className="card-desc">Master design and consulting for extreme-force adventure parks.</p>
              </div>
            </div>
          </div>
          ...
          <div className="showcase-content-blocks">
            <div className="pillar-content block-living">
              ...
              <p>
                Experiential learning, outdoor camps, and leadership development for schools, colleges, and corporate teams — moving growth out of the classroom and into nature.
              </p>
            ...
            <div className="pillar-content block-adventure">
              ...
              <p>
                Ziplines, kayaking, bamboo rafting, and custom-curated wilderness expeditions across Kerala's wildest landscapes.
              </p>
            ...
            <div className="pillar-content block-habitat">
              ...
              <p>
                Glamping, tensile tree tents, tipis, and dome eco-retreats — staying immersed in the wild without leaving comfort behind.
              </p>
            ...
            <div className="pillar-content block-projects">
              ...
              <p>
                Planning, engineering, and building adventure park grids, ziplines, tree nets, and destination ecotourism locations across India.
              </p>
      ...
      {/* Safety Panels Coda */}
      <section className="safety-panel" id="safety1">
        <div className="bg"></div>
        <div className="overlay"></div>
        <div className="content">
          <span className="eyebrow">Safety Redundancy</span>
          <h3>Built for extreme forces.</h3>
          <p>
            We exclusively use CE and UIAA-certified protective equipment — every harness, helmet, and carabiner is climbing-grade, with double-redundant belay systems.
          </p>
        </div>
      </section>

      <section className="safety-panel" id="safety2">
        <div className="bg"></div>
        <div className="overlay"></div>
        <div className="content">
          <span className="eyebrow">Pre-Flight Protocol</span>
          <h3>Inspections, without exception.</h3>
          <p>
            Every morning begins with rigorous multi-point stress logs — our certified safety officers test every anchor point before a single guest arrives.
          </p>
        </div>
      </section>
      ...
      <section id="faq" className="section-pad">
        ...
        <div className="faq-container">
          <div className="faq-item" onClick={toggleFaq}>
            ...
            <div className="faq-a">
              Safety is our top priority — every experience uses certified climbing-grade equipment, highly trained facilitators, and strict pre-activity safety logs.
            </div>
          </div>
